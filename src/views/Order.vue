<template>
  <el-card class="order-container">
    <template #header>
      ...
      <el-button type="primary" size="small" @click="handleConfig()"><el-icon><house /></el-icon>配货完成</el-button>
      <el-button type="primary" size="small" @click="handleSend()"><el-icon><house /></el-icon>出库</el-button>
      <el-button type="primary" size="small" @click="handleClose()"><el-icon><house /></el-icon>关闭订单</el-button>
    </template>
    <el-table
      :loading="loading"
      :data="tableData"
